...
export default function StartMenu({ isOpen, onClose }: StartMenuProps) {
  ...
  return (
    <div
      ref={menuRef}
      className={`
        fixed bottom-14 left-2 w-[90vw] max-w-[750px] h-[80vh] max-h-[500px]
    ...
    >
      ...
      <div className="flex-1 flex">
        ...
        {/* Left Column */}
        <div className="w-[52.5%] p-4 pr-3 flex flex-col overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
